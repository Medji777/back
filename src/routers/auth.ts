...
import {validateBodyLogin, validateExistUserOnEmailOrLogin, validationConfirmed} from "../validations";
...
authRouter.post('/registration',sanitizationBodyReg,validateBodyReg,validateExistUserOnEmailOrLogin,registration)
